...
#error "Please define a way to initialize a memory block."
	...
	ee_printf("Compiler version : GCC %s\n",COMPILER_VERSION);
...
#if HAS_FLOAT
		if (known_id==3) {
			ee_printf("CoreMark 1.0 : %f / GCC %s %s",default_num_contexts*results[0].iterations/time_in_secs(total_time),COMPILER_VERSION,COMPILER_FLAGS);
